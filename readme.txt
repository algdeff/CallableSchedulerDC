...
5. ��������� � ���������� SchedulerDC
6. ��� ������ ������� � ������� maven �����: mvn compile
7. ��������� SchedulerDC: mvn exec:java -Dexec.mainClass="SchedulerDC.ServerStarter"
8. ����� �� ���������: CTRL+C

����� ���-�� ������� ������ � ���� ����������� .jar ����, �� ����� �������� � �������������:
1. ������� ����������� .jar: mvn package
2. ���� �������� � target/SchedulerDC-......-jar-with-dependencies.jar (����. ��������� ������� 'maven-assembly-plugin' � pom.xml)
3. ���� ����� ����������� � ����� ����� (������� �� "progFolder")
4. � ����� � ������ (progFolder) ������ ��������� ���� �������� transmitter.conf.xml
6. ������ .jar �� JVM: java -jar SchedulerDC-..(������)..-jar-with-dependencies.jar

===============================================================================================================
���������������� ����: transmitterorker.conf.xml
